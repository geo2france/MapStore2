...
describe('Featuregrid toolbar component', () => {
    ...
    it('check draw-feature button', () => {
        ...
        ReactDOM.render(<Toolbar events={events} mode="EDIT" isEditingAllowed={true} canEditGeometry={false} selectedCount={1} hasGeometry isSimpleGeom={false} />, document.getElementById("container"));
        button = document.getElementById("fg-draw-feature");
        expect(isVisibleButton(button)).toBe(false);
